    ...
    <div className='flex flex-col gap-[15px] bg-[#FFFFFF] p-[15px] shadow-md h-[820px] fixed w-[80%]'>
      ...
      <div className='flex items-center justify-between text-[15px]'>
        <div className='flex items-center justify-center gap-[15px]'>
          ...
          <div className='border rounded-[5px] p-[5px]'>
        ...
        <div className='flex items-center justify-center gap-[15px]'>
          <button className=''>
            <Link
              to={'/admin/products-category/trash'}
              className='p-[5px] border rounded-[5px] border-[#525FE1] hover:bg-[#525FE1] flex items-center justify-center gap-[5px]'
            >
              <FaTrashAlt />
              <span>Thùng rác</span>
            </Link>
