...
const EditSettingGeneral = () => {
  ...
  useEffect(() => {
    if (!role || !role.permissions.includes('settings-general_edit')) {
  ...
  return (
    ...
    >
      ...
      <div className='form-group'>
        ...
        />
        <FieldErrorAlert errors={errors} fieldName='websiteName'/>
      </div>
      <div className="flex flex-col gap-[10px]">
      ...
      <div className='form-group'>
        ...
        <input
          ...
          className='border p-[5px] rounded-[5px] text-[16px]'
        />
        <FieldErrorAlert errors={errors} fieldName='copyright'/>
      </div>
      <div>
        <button
          type='submit'
