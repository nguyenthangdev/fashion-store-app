...
import LayoutUser from '~/layouts/clientt/layoutUser/LayoutUser'
...
import LayoutDefaultClient from '~/layouts/clientt/layoutDefaultt/LayoutDefault'
import LayoutAuthClient from '~/layouts/clientt/layoutAuth/LayoutAuth'
