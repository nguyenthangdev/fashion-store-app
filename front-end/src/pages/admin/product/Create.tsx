...
const CreateProduct = () => {
  ...
  useEffect(() => {
    if (!role || !role.permissions.includes('products_create')) {
    ...
    <>
      ...
      >
        ...
        <div className="form-group">
          ...
          <FieldErrorAlert errors={errors} fieldName='product_category_id'/>
        </div>

        <div className="flex flex-col gap-2">
          <label>
            Đặc trưng <span className="text-red-500">*</span>
          </label>
        ...
        <div className="form-group">
          ...
          <input
            ...
            max={100}
          />
          <FieldErrorAlert errors={errors} fieldName='discountPercentage'/>
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            min={1}
          />
          <FieldErrorAlert errors={errors} fieldName='stock'/>
        </div>
        ...
        <div className="form-group">
          ...
          <FieldErrorAlert errors={errors} fieldName='colors'/>
              ...
              <div key={colorIndex} className="border p-4 rounded-md">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span style={{ backgroundColor: color.code }} className="w-6 h-6 rounded-full border" />
        ...
        {showPopupColor && (
          <div className="fixed inset-0 left-[150px] bottom-[-200px] flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
              ...
              {/* Liệt kê các màu có sẵn để  bắt đầu chọn */}
              <div className="grid grid-cols-2 gap-3 mb-4 max-h-96 overflow-y-auto">
                {availableColors.map(( color: { code: string, name: string}) => {
                  // kiểm tra xem từng màu đã đc chọn ở trong mảng tempSelectedColors có nằm trong danh sách các màu có sẵn hay không?
        ...
        <div className="form-group">
          ...
          <FieldErrorAlert errors={errors} fieldName='sizes'/>
